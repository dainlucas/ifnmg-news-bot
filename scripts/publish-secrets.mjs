...
const discordNames=['DISCORD_BOT_TOKEN','DISCORD_PUBLIC_KEY'];
if(discordNames.some(name=>all[name])) {
  if(discordNames.some(name=>!all[name])) throw new Error('Missing Discord configuration');
  names.push(...discordNames);
}
